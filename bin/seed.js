...
const games = [
  {
    ...
    price: 9.99,
    category: { type: String, enum: ["action", "shooter", "infiltration"] },
    id_tags: "",
  },
  {
    ...
    price: 59.99,
    category: { type: String, enum: ["RPG", "adventure"] },
    id_tags: "",
  },
  {
    name: "Cyberpunk 2077",
    ...
    category: {
      type: String,
      enum: ["action", "shooter", "infiltration", "adventure", "RPG"],
    },
    id_tags: "",
  },
  {
    ...
    price: 39.99,
    category: { type: String, enum: ["action", "adventure"] },
    id_tags: "",
  },
  {
    ...
    price: 59.99,
    category: { type: String, enum: ["racing"] },
    id_tags: "",
  },
  {
    ...
    price: 29.99,
    category: { type: String, enum: ["adventure"] },
    id_tags: "",
  },
];
